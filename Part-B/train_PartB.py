...
def arg_parse():
    ...
    return num_epochs, batch_size, data_augmentation, optimizer, wandb_sweep, learning_rate,wandb_project,wandb_entity


# In[ ]:


num_epochs, batch_size, data_augmentation, optimizer, wandb_sweep, learning_rate, wandb_project, wandb_entity = arg_parse()
