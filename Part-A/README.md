...
Description of various command line arguments
    ...
    --wandb_sweep : Do you want to sweep or not: Enter True or False. Default value is False. Enter below arguments only if this is 'no'
    --model : Pretrained model to use: string value
