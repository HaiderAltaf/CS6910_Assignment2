...
def arg_parse():
    ...
    print("wandb_project :", wandb_project , "wandb_entity: ", wandb_entity, "epochs: ",
          num_epochs,"batch_size: ",batch_size, "dense_layer: ", size_denseLayer,
          "activation_function: ", act_fu,"data augmentation: ", data_augmentation, 
          "batch Normalization: ", batch_normalisation)
    
    return wandb_project, wandb_entity,wandb_sweep, num_epochs, batch_size, act_fu, size_denseLayer, data_augmentation,batch_normalisation


# In[ ]:


wandb_project, wandb_entity, wandb_sweep, num_epochs, batch_size, act_fu, size_denseLayer, data_augmentation,batch_normalisation =  arg_parse()
